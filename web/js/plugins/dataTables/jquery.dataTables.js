...
(/** @lends <global> */function( $ ) {
	 ...
	 * `pop`, `reverse` etc) as well as additional util methods (`each`, `pluck`,
	...
	DataTable.defaults = {
		 ...
		 *       <ul>
		 *         <li>'H' - jQueryUI theme "header" classes ('fg-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-util-clearfix')</li>
		 *         <li>'F' - jQueryUI theme "footer" classes ('fg-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-util-clearfix')</li>
		 *       </ul>
		 *     </li>
	...
	var _headerFooter = _empty + 'fg-toolbar ui-toolbar ui-widget-header ui-util-clearfix';
